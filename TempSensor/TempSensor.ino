 //LM35 output voltage has a linear relation with the Celsius temperature, thus an output of 0 v when 0 ℃, 
 //everytime it increases by 1 ℃, the output voltage increase 10 mv

#define lmPin A0  //LM35 attach to A0
#include <Wire.h> 
